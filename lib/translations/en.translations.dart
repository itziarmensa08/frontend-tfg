...
final Map<String, String> en = {
  ...
  //LoginPage
  'login': 'Login',
  'forgotPass': 'Have you forgotten your password?',
  'notAccount': 'Don\'t you have an account yet?',
  'username': 'Username',
  'pass': 'Password',
  'getIn': 'GET IN',
  ...
  'usersTitle': 'Users Overview',
  'usersSubtitle': 'View and manage existing users',
  'aircraftsTitle': 'Aircrafts Overview',
  ...
  'succesAddAirport': 'Airport added successfully',
  ...
  'addAirportStep1': 'or add the details if you can\'t find it: '
};