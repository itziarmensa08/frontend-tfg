...
final Map<String, String> es = {
  ...
  'dpDistance': "Distancia desde el DER hasta el DP (NM) (Opcional)",
  'dpDistanceNoOptional': "Distancia desde el DER hasta el DP (NM)",
  'dpAltitude': "Altitud requerida en el decision point (ft)",
  "weight": "Peso del avión en el peor caso (LB)",
  ...
  'noArriveNoDistanceDP': "Estás estudiando un caso donde no tenemos distancia al punto crítico y la queremos calcular, en este caso la altitud de éste es mayor que la altitud al final del segmento, por lo tanto tenemos que seguir estudiando el siguiente segmento.",
  'yesArrive': "En este punto la aeronave ha alcanzado el punto crítico, vamos a calcular si es capaz de sobrepasarlo:",
  'yesArriveNoDistanceDP': "Estás estudiando un caso donde no tenemos distancia al punto crítico y la queremos calcular, en este caso la altitud de éste es menor que la altitud al final del segmento, por lo tanto vamos a calcular qué distancia recorre:",
  'timeToDP': "Tiempo que tarda en llegar al punto crítico:",
  'altitudeInDP': "Incremento de altitud desde el comienzo del segmento:",
  'distanceInDP': "Distancia recorrida hasta el punto crítico:",
  ...
  'enter2Data': 'Introduce 2 de estos datos:',
