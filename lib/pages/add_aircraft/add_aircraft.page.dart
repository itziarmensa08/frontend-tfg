...
import 'package:frontend_tfg/pages/add_aircraft/widgets/desktop_view.dart';
import 'package:frontend_tfg/pages/add_aircraft/widgets/mobile_view.dart';

class AddAircraftPage extends StatefulWidget {
  const AddAircraftPage({super.key});

  @override
  AddAircraftPageState createState() => AddAircraftPageState();
}

class AddAircraftPageState extends State<AddAircraftPage> with TickerProviderStateMixin{
