...
import 'package:frontend_tfg/pages/settings/pages/notis/widgets/desktop_view.dart';
import 'package:frontend_tfg/pages/settings/pages/notis/widgets/mobile_view.dart';
...
class NotisPage extends StatefulWidget {
  ...
  @override
  NotisPageState createState() => NotisPageState();
}

class NotisPageState extends State<NotisPage> with TickerProviderStateMixin{
