...
class VyTable extends StatelessWidget {
  const VyTable({super.key, required this.table, required this.obtainedData});
  ...
  TableRow _buildPressureRow() {
    List<int> values = [0, 5000, 10000, 15000, 20000, 25000, 30000];
    List<Widget> cells = [
